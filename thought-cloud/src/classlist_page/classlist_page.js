...
function SearchResultItem(props) {
    ...
    const addUser = async () => {
        ...
        const result = await courseRequests.addUserToClass(member.ID, member.firstName, member.lastName, props.course);
    ...
    return (
        ...
        <div className="result-item" style={{ display: "flex", backgroundColor: "brown", margin: "5px", border: "2 solid", width: "30vw", height: "10vh" }}>
    ...
    return (
        ...
        <div id="member-modal" className="add-member-modal" hidden = {true} >
            ...
            <div className="search-result">
                {
                    result.map(e => < SearchResultItem member={e} course={props.course} />)
                }
            </div>
            ...
            <div className="classlist-page-wrapper">
                <button onClick={this.addNewMember}>Add New Member</button>
                {
                    <div style={{ display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center" }}>
                        ...
                        {this.state.classList.length != 0 ? this.state.classList.map(e => <MemberItem member={{ "name": e.firstName + " " + e.lastName }} />) : "No Members Yet"}
